            ...
            <div class="w-full px-10 flex flex-col justify-center">
                ...
                <form wire:submit="login" class="space-y-5">
                    ...
                    <div class="mt-4 text-center">
                        <a href="{{ route('admin.login') }}" class="text-xs text-[#49454F] hover:text-[#6750A4] font-medium transition-colors inline-flex items-center gap-1">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                            Login sebagai Admin / Staf Perpustakaan
                        </a>
                    </div>
                </form>
            </div>
